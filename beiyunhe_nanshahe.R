...
###################C
C_chushi <- read_excel("M:/myworkspace/COD_beiyunhe/nanshahe.xlsx", range = "B1:B169", sheet = 'Sheet1')
C_chushi = C_chushi[[1]]
library(fitdistrplus)
fitdist(C_chushi,'gamma')

sample_C = rgamma(50,shape=1.28275323, rate=0.02039273)    ####抽取多少???
sample_C = rgamma(50,shape=0.9893481, rate=1.2688828)    #NH3N
sample_C = rgamma(50,shape=2.068557, rate=2.831307)    #TP



##############vvvvvvv W vvvvvv
Q_pai = 0.26223998
Cs = 30   #NH3N 1.5   TP 0.3
W = seq(8,60,by=1)
W = seq(0.4,0.76,by=0.01)  #NH3N
W = seq(0.1,0.38,by=0.01)  #TP

p_W_prior = dnorm(W,mean=24.6,sd=9)
p_W_prior = dnorm(W,mean=0.58,sd=0.07)   #NH3N
p_W_prior = dnorm(W,mean=0.24,sd=0.04)   #TP
